...
if ($BuildFailed -eq $False) {
  ...
  if ((Test-Path -PathType Container $RedistDirectory) -eq $False) {
    ...
    Copy-Item -Force "${env:ProgramFiles(x86)}/Microsoft Visual Studio/2019/Professional/VC/Redist/MSVC/14.25.28508/MergeModules/Microsoft_VC142_CRT_x64.msm" -Destination $RedistDirectory
